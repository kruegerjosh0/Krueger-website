...
export const siteSettings = pgTable("site_settings", {
  ...
  phone: text("phone").notNull().default("262-339-5822"),
  facebookUrl: text("facebook_url").notNull().default("https://facebook.com"),
  logoUrl: text("logo_url").notNull().default(""),
  footerText: text("footer_text").notNull().default("© 2026 Krieger Painting DBA Krueger Painting. All rights reserved."),
  ...
  heroDescription: text("hero_description").notNull().default("Professional interior and exterior painting, drywall repair, and pressure washing across Washington County, Wisconsin."),
  heroPrimaryButton: text("hero_primary_button").notNull().default("Get Free Estimate"),
